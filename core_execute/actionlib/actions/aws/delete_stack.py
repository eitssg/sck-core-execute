...
class DeleteStackAction(BaseAction):
    ...
    def _execute(self):
        ...
        if stack_status == "DELETE_COMPLETE":
            ...
            log.info("Stack '{}' deletion already in progress with status '{}'", self.params.stack_name, stack_status)
        ...
        try:
            ...
            log.error("Failed to initiate stack deletion for '{}': {} - {}", self.params.stack_name, error_code, error_message)
    ...
    def _check(self):
        ...
        if stack_status == "DELETE_COMPLETE":
            ...
            log.debug("Stack '{}' deletion in progress with status '{}'", self.params.stack_name, stack_status)
            ...
            # Unexpected status
            log.warning("Stack '{}' has unexpected status '{}'", self.params.stack_name, stack_status)
    ...
    def _unexecute(self):
        ...
        log.warning("Stack deletion cannot be rolled back - Stack '{}' remains in its current state", self.params.stack_name)
    ...
    def _get_stack_status(self, cfn_client) -> dict[str, Any]:
        ...
        try:
            ...
            if "does not exist" in error_message or error_code == "ValidationError":
                ...
                log.error("Error describing stack '{}': {} - {}", self.params.stack_name, error_code, error_message)
                raise
